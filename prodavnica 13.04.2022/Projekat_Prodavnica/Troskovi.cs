...
"order by zd.id ", cn);
        ...
        private void cmbNazivArtikla_Troskovi_SelectionChangeCommitted(object sender, EventArgs e)
        {
            cn.Open();
        ...
        private void textKolicina_Troskovi_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void textRabat_Troskovi_KeyDown(object sender, KeyEventArgs e)
        {
            if ((e.KeyCode == Keys.Enter) || (e.KeyCode == Keys.Tab))
            {
